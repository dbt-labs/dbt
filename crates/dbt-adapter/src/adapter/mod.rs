...
impl Adapter {
    pub fn call_method_impl(
        ...
        match name {
            ...
            "get_glue_table_type" => self.athena_get_glue_table_type(args),
            "clean_up_table" => self.athena_clean_up_table(args),
            "delete_from_glue_catalog" => self.athena_delete_from_glue_catalog(args),
            "drop_glue_database" => self.athena_drop_glue_database(args),
            ...
            "upload_seed_to_s3" => self.athena_upload_seed_to_s3(args),
