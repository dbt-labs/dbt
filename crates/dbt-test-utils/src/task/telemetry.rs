...
use dbt_common::{
    ...
    constants::{DBT_LOG_DIR_NAME, DBT_TARGET_DIR_NAME, default_telemetry_dir},
    err, stdfs,
};
...
fn compare_telemetry(
    ...
    let actual_parquet_path = default_telemetry_dir(&target_dir).join(OTEL_PARQUET_FILE_NAME);
