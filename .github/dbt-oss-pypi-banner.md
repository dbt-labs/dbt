...
>
> With v2, you no longer need to install adapters separately, so you can remove `pip install dbt-<adapter>` from your installation. [See the install docs](https://docs.getdbt.com/docs/local/install-dbt?utm_source=dbt-cli) to get started.
